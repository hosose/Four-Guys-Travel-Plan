 ...
 * App URI: udc/myPageMyInfo
 * Source Location: udc/myPageMyInfo.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/myPageMyInfo", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
	...
	internalApp.title = "myPageMyInfo";
	
	// Type declaration for myPageMyInfo
	cpr.utils.Util.ensurePackage("udc").myPageMyInfo = function(id){
		cpr.controls.UDCBase.call(this, "udc.myPageMyInfo", internalApp, id);
	};
	
	udc.myPageMyInfo.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.myPageMyInfo.prototype, "type", {
		get : function(){
			return "udc.myPageMyInfo";
		},
...
/// start - udc.nav_header
/*
 * UDC Qualified Name: udc.nav_header
 * App URI: udc/nav_header
 * Source Location: udc/nav_header.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/nav_header", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
				...
				/************************************************
				 * nav_header.js
				 * Created at 2023. 8. 4. 오후 1:35:35.
				 *
				 * @author USER
				 ************************************************/
	...
	internalApp.title = "nav_header";
	
	// Type declaration for nav_header
	cpr.utils.Util.ensurePackage("udc").nav_header = function(id){
		cpr.controls.UDCBase.call(this, "udc.nav_header", internalApp, id);
	};
	
	udc.nav_header.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.nav_header.prototype, "type", {
		get : function(){
			return "udc.nav_header";
		},
